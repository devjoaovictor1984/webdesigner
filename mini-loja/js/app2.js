...
var products = [
  ...
  { id: 2, name: "Cheddar Bacon Smash", description: "Dois smash burgers 80g, cheddar cremoso, bacon crocante e cebola crispy.", price: 29.9, category: "burger", emoji: "🥓", calories: "890 kcal", tag: "Cheddar Lovers" },
...
var checkoutWhatsappButton = document.querySelector("#checkout-whatsapp");
...
function addToCart(productId) {
  ...
  console.table(cart); // DEBUG AO VIVO
  renderCart();
}

// 9.2 - Delegação do botão Adicionar
...
// 9.3 - Delegação dos botões do carrinho
...
function applyCoupon() {
  ...
  var validCoupons = { JVV10: 10, LIVRO15: 15 };
...
adminForm.addEventListener("submit", function (event) {
  ...
  alert("Produto adicionado ao cardápio (apenas front-end, sem salvar no servidor).");
});
